...
#define TONGSUO_VERSION2(a, b, c) RUST_VERSION_TONGSUO_##a##_##b##_##c
#define TONGSUO_VERSION(a, b, c) TONGSUO_VERSION2(a, b, c)
...
#ifdef TONGSUO_VERSION_MAJOR
TONGSUO_VERSION(TONGSUO_VERSION_MAJOR, TONGSUO_VERSION_MINOR, TONGSUO_VERSION_PATCH)
RUST_CONF_OPENSSL_NO_BF
RUST_CONF_OPENSSL_NO_IDEA
RUST_CONF_OPENSSL_NO_CAMELLIA
RUST_CONF_OPENSSL_NO_CAST
RUST_CONF_OPENSSL_NO_GOST
RUST_CONF_OPENSSL_NO_RMD160
RUST_CONF_OPENSSL_NO_SEED
RUST_CONF_OPENSSL_NO_MD2
RUST_CONF_OPENSSL_NO_MD4
RUST_CONF_OPENSSL_NO_MDC2
RUST_CONF_OPENSSL_NO_RC2
RUST_CONF_OPENSSL_NO_RC4
RUST_CONF_OPENSSL_NO_RIPEMD
RUST_CONF_OPENSSL_NO_WHIRLPOOL
#elif defined(BABASSL_VERSION_NUMBER)
